  ...
  return (
    <div className={styles.toolbar}>
      <div className={styles.navButtons}>
        <ToolbarButton onClick={handleBack} title="Back (Alt+Left)" aria-label="Go back">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="m12 19-7-7 7-7M19 12H5" />
          </svg>
        </ToolbarButton>
        <ToolbarButton onClick={handleForward} title="Forward (Alt+Right)" aria-label="Go forward">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M5 12h14m-7-7 7 7-7 7" />
          </svg>
        </ToolbarButton>
        <ToolbarButton onClick={handleRefresh} title="Reload (Ctrl+R)" aria-label="Reload page">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
